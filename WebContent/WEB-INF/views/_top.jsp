										...
										function(data) {
											if (data == "not logged in") {
												$("#li-login").removeClass(
														'hidden');
												$("#li-register").removeClass(
														'hidden');
											} else if (data == "logged in") {
												$("#li-logout").removeClass(
														'hidden');
												$("#li-MyPage").removeClass(
														'hidden');
												$("#li-edit").removeClass(
														'hidden');
											}
...
<div id="top">
	<div class="container">
		...
		<div class="col-md-6" data-animate="fadeInDown">
			<ul class="menu">
				<li class="hidden" id="li-login"><a href="#"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<p class="text-center text-muted">
						<a href="user_register"><strong>바로 가입하세요</strong></a>! 가입하는데 아주
						간단해 &nbsp;1분밖에 걸리지 않는다구요! 어서 가입해서 특별 할인을 받으세여!
					</p>
